...
export function Hero() {
  return (
    <section className="relative overflow-hidden hero-gradient">
      ...
      <div className="mx-auto max-w-[1400px] px-4 md:px-8 py-24 md:py-36 lg:py-48 xl:py-52 relative">
        <div className="flex flex-col items-center text-center">
          ...
          {/* Main headline */}
          <h1 className="max-w-5xl text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl xl:text-[5.5rem] animate-in-up leading-[1.1]">
            Transform Any{" "}
          ...
          {/* Subheading */}
          <p className="mt-8 max-w-2xl text-lg text-muted-foreground md:text-xl lg:text-2xl xl:text-2xl animate-in-up stagger-2 leading-relaxed">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4 md:gap-6 lg:gap-8 animate-in-up stagger-3">
            {[
              { icon: Zap, text: "Instant Generation" },
              { icon: Brain, text: "Spaced Repetition" },
              { icon: Star, text: "AI-Powered" },
            ].map((item) => (
              <div key={item.text} className="flex items-center gap-2 text-sm lg:text-base text-muted-foreground">
          ...
          {/* Social proof bar */}
          <div className="mt-14 flex flex-col sm:flex-row items-center gap-6 lg:gap-8 animate-in-up stagger-5">
            {/* Avatars */}
            <div className="flex items-center gap-3">
              <div className="flex -space-x-2.5">
                {["bg-blue-500", "bg-emerald-500", "bg-purple-500", "bg-orange-500", "bg-pink-500"].map((color, i) => (
                  <div
                    key={i}
                    className={`h-9 w-9 lg:h-10 lg:w-10 rounded-full border-2 border-background ${color} flex items-center justify-center text-white text-xs font-bold ring-2 ring-background`}
                  >
          ...
          {/* Hero preview card */}
          <div className="mt-20 w-full max-w-6xl xl:max-w-[1200px] animate-in-up stagger-6">
              ...
              <div className="p-6 md:p-8 lg:p-10">
                ...
                <div className="space-y-2">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-3 rounded-lg border p-3 lg:p-4 bg-background/50 hover:bg-accent/30 transition-colors">
                      <div className={`h-8 w-8 lg:h-10 lg:w-10 rounded-lg flex items-center justify-center ${
